...
#define MAX_STR_LEN 128 //Must be greater than 1
#define MAX_VOTES 10 //Must be greater than 1
#define NUM_OF_AREAS 101 //Do not lower beneath 12
#define NUM_OF_TRIBES 300 //Do not lower beneath 12
